...
const ProductTemplate = () => {
  ...
  // (Supabase variation group system removed — only sub_model metafields used now)

  // (Cosmetic variant strip and other-trims notice removed — only sub_model bed_length/cab_type used now)
