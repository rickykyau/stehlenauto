    ...
    <div className="min-h-screen flex items-center justify-center bg-background px-4">
      <div className="w-full max-w-sm space-y-8">
        <div className="flex flex-col items-center gap-4">
          ...
          <h1 className="font-display text-xs tracking-[0.25em] text-muted-foreground">
        ...
        <div className="space-y-4">
          <button
            ...
            disabled={loading}
            className="w-full flex items-center justify-center gap-3 h-12 border border-border bg-card text-foreground font-body text-sm hover:bg-accent/50 transition-colors disabled:opacity-50"
          >
            {loading ? (
